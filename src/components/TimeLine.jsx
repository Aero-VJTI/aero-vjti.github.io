...
const timelineData = [
  {
    ...
    description: 'A student-driven club at VJTI focused on aeromodelling, drones, and aerospace projects.',
    image: '/timeline/event_image.jpg',
  },
  {
    year: '2022',
  ...
  },
  {
    ...
    description: 'Participated in AeroDesign competitions, showcasing drones and RC aircraft innovations.',
    image: '/timeline/image2.png',
  },
  {
    year: '2024',
    title: 'Research & Innovation',
    description: 'Working on sustainable UAV designs and AI-powered drones for real-world applications.',
    image: '/timeline/image2.png',
  },
  {
    year: '2025',
    title: 'Future Vision',
    description: 'Expanding AeroVJTI into a leading aerospace student club with global recognition.',
    image: '/timeline/image2.png',
  },
];
...
<p className=" text-center text-2xl underline-offset-1 font-bold text-white font-mono">
      ...
      <div
        ...
        className=" pt-10 space-y-12 relative before:absolute before:inset-0 before:ml-5 
                 ...
                 before:from-transparent before:via-slate-300 before:to-transparent p-4 w-[80%]"
      >
